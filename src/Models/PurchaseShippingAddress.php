...
use Bonlineza\DearDatabase\Database\Factories\PurchaseShippingAddressFactory;
...
class PurchaseShippingAddress extends Model
{
    ...
    {
        return PurchaseShippingAddressFactory::new();
    }
