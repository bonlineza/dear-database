...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('purchase_invoice_purchase_invoice_additional_charge', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('purchase_invoice_purchase_invoice_additional_charge');
    }
};
